...
Subsystem roadmaps translate the canonical eggcalc direction into coherent, dependency-aware workstreams. They are not direct coding-agent checklists. Adapted from `codegg/plans/subsystems/README.md`.
...
```text
calculator-core-roadmap.md
exact-utilities-roadmap.md
mcp-server-roadmap.md
cli-distribution-roadmap.md
```
...
Describe the end-state module, protocol, ownership, and lifecycle model for this subsystem.
