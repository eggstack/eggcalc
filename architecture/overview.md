...
- [Subsystem Map](#subsystem-map)
  ...
  - [exact/ — Unicode Text Analysis Package (25 modules)](#exact--unicode-text-analysis-package-25-modules)
...
| Component | Document | Covers |
|-----------|----------|--------|
| Package overview (all 25 modules) | [exact.md](exact.md) | Structure, dependency graph, full API listing |
