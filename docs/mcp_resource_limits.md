...
| `json_query` | json | 2 | `text`, `pointer` | 100,000 text, 4,096 pointer | — | — | linear | `_require_str(MAX_TEXT_LENGTH)`, pointer ≤ 4096 | no | `test_mcp_server.py` | **Deprecated** — use json_extract |
